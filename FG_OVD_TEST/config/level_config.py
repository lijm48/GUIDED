...
from .base_config import model, Custom_DatasetMapper
...
dataloader.test.dataset.names = "FG_OVD_val_1_attr_level"

dataloader.test = L(build_detection_test_loader)(
    dataset=L(get_detection_dataset_dicts)(names="FG_OVD_val_1_attr_level", filter_empty=False),
    mapper=L(Custom_DatasetMapper)(
        augmentation=[
