...
def saveObject(obj, path):
    ...
    Args:
        obj: Object to save.
        path: File path to save the object to.
    """
    print("Saving " + path)
...
def get_lami_detr_models(args: argparse.Namespace):
    ...
    clip_model, tokenizer = getClip_model(model_name = 'convnext_large_d_320', ckpt_file = paths.clip_ckpt)
...
def main():
    ...
    parser.add_argument('--coco_path', type=str, default=paths.coco_path + '/', help='Path to COCO dataset root directory')
