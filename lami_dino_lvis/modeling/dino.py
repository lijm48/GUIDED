...
class DINO(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            #! change: get input_query_label_idx
            input_query_label, input_query_label_idx, input_query_bbox, attn_mask, dn_meta = self.prepare_for_cdn(
                targets,
        ...
        #! change: get input_query_label_idx
            input_query_label_idx = None
        query_embeds = (input_query_label, input_query_bbox, input_query_label_idx)
    ...
    def prepare_for_cdn(
        ...
        #! change: get input_query_label_idx
        input_query_label_idx = torch.zeros(batch_size, pad_size).long().cuda()
        ...
        if len(known_bid):
            ...
            #! change: get input_query_label_idx
            input_query_label_idx[(known_bid.long(), map_known_indice)] = m
        ...
        #! change: get input_query_label_idx
        return input_query_label, input_query_label_idx, input_query_bbox, attn_mask, dn_meta
