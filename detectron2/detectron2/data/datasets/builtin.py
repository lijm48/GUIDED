...
FG_OVD = {
    ...
    "FG_OVD_train_1_attr_with_subject_multi_vocab": ("coco/", "FG_OVD/training_sets/with_subject_and_atomic_phrases/1_attributes_with_subject_with_multi_vocab_single.json"),
    ...
    "FG_OVD_bench_transparency_with_subject": ("coco/", "FG_OVD/benchmarks/with_subject_and_atomic_phrases/transparency_with_subject_with_multi_vocab_single.json"),
...
def _get_dataset_root():
    root = os.getenv("DETECTRON2_DATASETS") or os.getenv("GUIDED_DATASET_PATH")
    if root:
    ...
    try:
        ...
        return os.path.expanduser(paths.dataset_path)
    except Exception:
        return "dataset"
