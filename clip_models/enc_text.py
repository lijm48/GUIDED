...
def getClip_model_preprocess_tokenizer(model_name = 'convnext_large_d_320', ckpt_file = None, precision='fp32'):
    """
    args:
        model_name: the name of the model
        ckpt_file: the checkpoint file of the model
